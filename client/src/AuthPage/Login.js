...
export default function Login ({switchAuthHandler}) {
    ...
    const isButtonDisabled = isLoading || !formState.password.isValid || !formState.email.isValid

    console.log(formState, isButtonDisabled)
  ...
  return (
    <div className="login-container">
        ...
        <form className='auth-form'>
            ...
            <button onClick ={handleLogin} disabled={isButtonDisabled}>Log In</button>
        </form>
